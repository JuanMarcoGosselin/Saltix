...
urlpatterns = [
    ...
    path(
        "jefatura/asistencias/cancelar/",
        views.cancelar_asistencia_institucional,
        name="cancelar_asistencia_institucional",
    ),
    path(
        "jefatura/asistencias/corregir/",
        views.corregir_asistencia_jefatura,
        name="corregir_asistencia_jefatura",
    ),
